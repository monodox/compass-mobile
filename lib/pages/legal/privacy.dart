      ...
      body: ListView(
        ...
        children: [
          ...
          LegalSection('6. Third-Party Services',
              'Compass uses third-party APIs (AI, Voice, Vision). These services have their own privacy policies which we encourage you to review.'),
          ...
          LegalSection('8. Contact', 'Privacy questions: privacy@compass.app'),
